...
| Add versioned `multiview_render_v2` orbit camera | implemented, unit-tested, and real-smoke verified on 5 cube + 1 cylinder views; full 180 realization not run; v1 untouched; no training | Sole scientific change is camera viewpoint sampling (±18° azimuth, ±10° elevation, ±5% distance) around the object center; all training and non-camera render semantics remain locked |
