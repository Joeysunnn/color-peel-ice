...
| Add versioned `multiview_render_v2` orbit camera | implemented, unit-tested, real-smoke verified, and realized 180/180; three 96-image folds staged with nine configs pending human review; v1 untouched; no training | Sole scientific change is camera viewpoint sampling (±18° azimuth, ±10° elevation, ±5% distance) around the object center; all training and non-camera render semantics remain locked |
