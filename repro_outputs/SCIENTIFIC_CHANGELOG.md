...
| Add versioned `multiview_render_v2` orbit camera | implemented, unit-tested, real-smoke verified, and realized 180/180; human review passed; nine Fold runs launched sequentially and currently running; v1 untouched | Sole scientific change is camera viewpoint sampling (±18° azimuth, ±10° elevation, ±5% distance) around the object center; all training and non-camera render semantics remain locked |
