...
|---|---|---|---|---|---|
| [01](01_colorpeel_clevr_baseline.md) | ColorPeel can be evaluated on the locked CLEVR 3×3 six-token grid without ICE method additions | `../configs/baseline.yaml` | pending | — | pending |
