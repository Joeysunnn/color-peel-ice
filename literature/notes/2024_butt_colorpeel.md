...
- Fixing the final-token gradient defect and allowing literal official AdamW drift both require separate comparability disclosure; neither follows merely from the paper's result claims.
...
- Preserve literal official AdamW decay, record ordinary-vocabulary drift, and do not treat it as a failure by itself.
